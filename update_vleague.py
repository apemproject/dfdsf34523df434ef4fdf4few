...
LOCAL_TZ = timezone(timedelta(hours=7))  # WIB
CHECK_WINDOW = timedelta(minutes=60)  # cek src ±60 menit dari sekarang
...
def fetch_hls_src(match):
    """Hanya cek src untuk pertandingan ±CHECK_WINDOW menit dari sekarang atau jika src kosong"""
    try:
